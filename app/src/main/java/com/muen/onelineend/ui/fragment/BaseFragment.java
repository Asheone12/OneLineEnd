 ...
 */
public abstract class BaseFragment<T extends ViewBinding> extends Fragment implements BaseActivity.OnFragmentBackPressedListener, ViewUtil.ShareElementsListener {
     ...
     * 创建ViewBinding
     */
    abstract T onCreateViewBinding(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState);
